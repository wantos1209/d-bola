...
<div class="sec_box">
    <div class="sec_table">
        <h2>{{ $title }}</h2>
        <a href="/user/create" class="sec_addnew">
        ...
        <div class="tabs-keyword">
            <a href="/monitorjob" class="sec_addnew_tabs active">
            ...
            <a href="/failjob" class="sec_addnew_tabs ">
                    ...
                    <tr>
                        ...
                        <td class="kolom_action">
                            ...
                            <div class="action_crud">
                                <a href="/user/edit/{{ $d->id }}"><div class="list_action">
                                ...
                                <form action="/user/delete/{{ $d->id }}" method="POST" id="deleteForm{{ $d->id }}" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
