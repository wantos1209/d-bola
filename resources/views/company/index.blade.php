...
<div class="sec_box">
    <div class="sec_table">
        <h2>{{ $title }}</h2>
            <a href="/company/create" class="sec_addnew">
                    ...
                    <form>
                        ...
                        <td>
                            <div class="grubsearchtable">
                                ...
                                <input type="text" name="key" value="{{ request('key') }}" placeholder="Search key here ...">
                            </div>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="kolom_action">
                            ...
                            <div class="action_crud">
                                <a href="/company/edit/{{ $d->id }}"><div class="list_action">
                                ...
                                <form action="/company/delete/{{ $d->id }}" method="POST" id="deleteForm{{ $d->id }}" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
