...
<div class="sec_box">
    <div class="sec_table">
        <h2>{{ $title }}</h2>
            <a href="/groupmenu/create" class="sec_addnew">
            ...
            <div class="tabs-keyword">
                <a href="/menu" class="sec_addnew_tabs {{ Request::is("menu" . '/*') || Request::is("menu") ? 'active' : '' }}">
                ...
                <a href="/groupmenu" class="sec_addnew_tabs {{ Request::is("groupmenu" . '/*') || Request::is("groupmenu") ? 'active' : '' }}">
                        ...
                        <tr>
                            ...
                            <td class="kolom_action">
                                ...
                                <div class="action_crud">
                                    <a href="/groupmenu/edit/{{ $d->id }}"><div class="list_action">
                                    ...
                                    <form action="/groupmenu/delete/{{ $d->id }}" method="POST" id="deleteForm{{ $d->id }}" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
