...
<div class="sec_box">
    <div class="sec_table">
        <h2>{{ $title }}</h2>
            <a href="/game/create" class="sec_addnew">
            ...
            <tbody>
                ...
                @foreach($data as $d)
                    <tr>
                        ...
                        <td><img class="image-icon" src="{{ $d->icon }}" style="width: 80px"></td>
                        <td><span class="key">{{ $d->status == 1 ? 'ACTIVE' : 'NON-ACTIVE' }}</span></td>
                        ...
                        <td class="kolom_action">
                            ...
                            <div class="action_crud">
                                <a href="/game/edit/{{ $d->id }}"><div class="list_action">
                                ...
                                <form action="/game/delete/{{ $d->id }}" method="POST" id="deleteForm{{ $d->id }}" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
