...
<div class="sec_box hgi-100" style="height: 100%;">
    <div class="sec_form">
        ...
        <form action="/game/update/{{ $data->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="list_form">
                ...
                <input type="text" id="icon" name="icon" placeholder="https://games.bostoni.pro/lobby/slider/thmbkosm.png" value="{{ $data->icon }}" required>
            </div>
            <div class="list_form">
                <span class="sec_label">Status</span>
                <div class="sec_togle">
                    <input type="checkbox" id="switch-1" name="status" {{ $data->status == 1 ? 'checked' : '' }}>
