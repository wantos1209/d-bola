            ...
            <tbody>
                    ...
                    <form>
                        ...
                        <td>
                            <div class="grubsearchtable">
                                ...
                                <select name="month">
                                    <option class="sec_selected" value="all" selected="" place="" {{ request('month') == '' ? 'selected' : '' }}>ALL</option>
                                    @foreach ($dataMonth as $index => $month)
                                        <option value="{{ $index }}" {{ request('month') == $index ? 'selected' : '' }}>{{ $month }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <td>
                            <div class="grubsearchtable">
                                ...
                                <select name="year">
                                    @foreach ($dataYear as $index => $year)
                ...
                @foreach($data as $d)
                    <tr>
                        ...
                        <td><span class="key">{{ $d->year }}</span></td>
        ...
        $('#btnDownload').on('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const url = `/exportMonthlyWinlose?company=${company}&username=${username}&month=${month}&year=${year}`;
