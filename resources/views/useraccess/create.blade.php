...
<div class="sec_box hgi-100" style="height: 100%;">
    <div class="sec_form">
        ...
        <form action="/useraccess/store" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <tbody style="border-top: 0px">
                        ...
                        @foreach($dataMenu as $d)
                            <tr>
                                ...
                                <td class="check_box">
                                    <input type="checkbox" name="permissions[{{ $d->id }}][is_view]">
                                </td>
                                <td class="check_box">
                                    <input type="checkbox" name="permissions[{{ $d->id }}][is_create]">
                                </td>
                                <td class="check_box">
                                    <input type="checkbox" name="permissions[{{ $d->id }}][is_update]">
                                </td>
                                <td class="check_box">
                                    <input type="checkbox" name="permissions[{{ $d->id }}][is_delete]">
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
